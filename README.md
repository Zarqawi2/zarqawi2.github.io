...
Visitor and support counts are saved with CounterAPI public counters through a CORS-enabled proxy. The app uses browser local storage to avoid counting the same browser repeatedly.
