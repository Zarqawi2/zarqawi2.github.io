<template>
  ...
  >
    <div
      class="relative isolate z-0 flex w-full h-[46vh] min-h-[280px] max-h-[520px] scale-y-125 items-center justify-center overflow-hidden pointer-events-none"
    >
      <!-- Conic Gradient -->
      <div
        :style="{
        ...
        class="animate-conic-gradient bg-gradient-conic absolute inset-auto right-1/2 h-56 w-60 overflow-visible from-[#7c3aed] via-transparent to-transparent text-white opacity-50 [--conic-position:from_70deg_at_center_top]"
      >
        <div
      ...
      <div
        ...
        class="animate-conic-gradient bg-gradient-conic absolute inset-auto left-1/2 h-56 w-60 from-transparent via-transparent to-[#7c3aed] text-white opacity-50 [--conic-position:from_290deg_at_center_top]"
      >
        <div
    ...
    <div
      class="relative z-50 -mt-32 sm:-mt-40 md:-mt-52 flex w-full flex-col items-center justify-start px-2 sm:px-3 py-3 sm:py-4 md:py-5 lg:py-6 gap-3 sm:gap-5"
    >
      <slot />
    </div>
  </div>
